...
import victoryIcon from "../../assets/images/victory.png";
import HeroImg from "../../assets/images/waleed-bhai.png";
  ...
  return (
    <>
      <div className="overflow-x-hidden">
        ...
        {/* Offcanvas menu */}
        <div
          className={`offcanvas right-0 top-0 bottom-0 z-50 fixed h-full w-[350px] md:w-[460px] bg-black-800 pl-8 flex flex-col justify-between transition-all duration-300 ${
            isOffcanvasOpen ? "translate-x-0" : "translate-x-full"
          }`}
        >
          <div className="flex justify-between items-center border-b border-border-white mb-[80px]">
            <a href="index.html">
              <img
            ...
            <ul>
              {[
                ...
                >
                  <Link
                    to={item.path}
                    className="text-white text-xl font-bold font-Syne flex items-center justify-between hover:text-orange transition duration-300"
                  >
                    {item.name}
        ...
        {/* Hero section start */}
        <section className="bg-secondary relative pt-[153px] pb-[55px] lg:pb-40 flex flex-col md:flex-row items-center">
          <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Text Content */}
            <div className=" pt-[300px] flex flex-col justify-center items-start xl:pt-12">
              <span className="font-Syne text-black-800 font-bold text-2xl lg:text-4xl flex items-center mb-3">
                <span className="mr-4">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="65"
                ...
                Hello, I’m
                <img className="ml-2" src={victoryIcon} alt="icon" />
              </span>
              ...
              <h2
                className="font-syne text-black-800 font-bold text-[80px] lg:text-[100px] xl:text-[120px] leading-[64px] lg:leading-[80px] mb-4"
                data-aos="fade-right"
                data-aos-delay="600"
              >
                Iqbal
              ...
              <p
                className="font-syne pt-2 text-black-700 font-bold text-lg md:text-xl xl:text-2xl leading-tight mb-8"
                data-aos="fade-right"
                data-aos-delay="700"
              >
              ...
              <div className="flex mb-8 space-x-4 ml-5">
                ...
                >
                  Let’s Talk
                  <span className="ml-3  group-hover:animate-arrow-move-up">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
            ...
            <div className="md:block">
              <img
                className="absolute top-0 xl:pt-[3px] right-0 md:max-w-[420px] lg:max-w-[570px] xl:max-w-[650px] 2xl:max-w-[initial] aos-init aos-animate"
                data-aos="fade-left"
                src={HeroImg}
                alt="icon"
              />
            ...
            >
              <div class="col-span-12 lg:col-span-6 xl:col-span-6">
                <div class="font-bold font-Syne leading-none flex flex-wrap flex-col gap-y-2">
                  ...
                  <h3 class="ml-7 mr-7 text-black-800 text-4xl lg:text-5xl xl:text-[64px] tracking-[-1.5px] relative before:rounded-full before:bg-primary before:block before:absolute before:top-[2px] before:left-0 before:-z-[1] before:w-[36px] lg:before:w-[48px] xl:before:w-[60px] before:h-[36px] lg:before:h-[48px] xl:before:h-[60px]">
                    My specialties
                  </h3>
                </div>
              </div>
              <div class="col-span-12 lg:col-span-6 xl:col-span-6">
                <p class="paragraph">
                  ...
                  extensive core competencies. Progressively repurpose
            ...
            <div class="grid grid-cols-12 gap-6">
              ...
              >
                <div class="px-6 py-9 bg-black-800 rounded-lg flex flex-wrap flex-col justify-between max-w-[416px] mx-auto h-full group">
                  <div class="flex flex-wrap justify-end relative xl:mr-4">
                    <a
                      href="contact.html"
                  ...
                  <div class="flex flex-col flex-wrap gap-y-2">
                    ...
                    <h4 class="text-white text-2xl xl:text-[28px] font-bold font-Syne leading-none">
                      info@waleediqbal.com
                    </h4>
                  </div>
                </div>
        ...
        {/* <!-- tabs start --> */}
        <section className="featured-properties py-20 lg:py-24">
              ...
              <div class="col-span-12" data-aos="fade-up">
                <div class="font-bold font-Syne text-center leading-none flex flex-wrap flex-col gap-y-2 mb-10">
                  ...
                  <h3 class="text-black-800 text-4xl lg:text-5xl xl:text-[64px] tracking-[-1.5px]">
                    My recent{" "}
                    <span class="relative z-[1] before:rounded-full before:bg-primary before:block before:absolute before:top-[4px] before:left-[-6px] before:-z-[1] before:w-[36px] lg:before:w-[48px] xl:before:w-[64px] before:h-[36px] lg:before:h-[48px] xl:before:h-[64px]">
                      w
                    </span>
                    ork
                  </h3>
        ...
        <section class="bg-white py-[120px] testimonial" data-aos="fade-up">
          <div class="pr-15 m-5 xl:pr-0 xl:pl-[4%] 2xl:pl-[6%] 3xl:pl-[17%]">
            <div class="pr-5 flex flex-col  xl:flex-row gap-x-[75 px] 2xl:gap-x-[100px] 3xl:gap-x-[165px]">
              <div class="font-bold font-Syne leading-none flex flex-wrap flex-col gap-y-2 md:text-center xl:text-left mb-10">
                ...
                <h3 class="inline-block text-black-800 text-4xl lg:text-5xl xl:text-[64px] tracking-[-1.5px]">
                  <span class="relative z-[1] before:rounded-full before:bg-primary before:block before:absolute before:top-[4px] before:left-[-2px] before:-z-[1] before:w-[36px] lg:before:w-[48px] xl:before:w-[64px] before:h-[36px] lg:before:h-[48px] xl:before:h-[64px]">
                    Cl
                  </span>
                  ient
              ...
              <div class="swiper w-full flex-row gap-x-[8px]">
                <div class="swiper-wrapper flex gap-x-[10px]">
